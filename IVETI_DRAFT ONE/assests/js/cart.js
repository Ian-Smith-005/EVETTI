        ...
        <div class="row">
          ...
          <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
            ...
            <button type="button" class="btn btn-danger btn-sm mb-2" data-mdb-toggle="tooltip"
              title="Move to the wish list" onclick="addToWishlist(this)">
  ...
  function updateSummary() {
    ...
    document.getElementById('total-amount').innerText = `KSH ${totalAmount.toFixed(2)}`;
    document.getElementById('cart-amount').innerText = `KSH ${totalAmount.toFixed(2)}`;
    document.getElementById('counter-items').innerText = cartItems.length;
    document.getElementById('product-counter').innerText = cartItems.length;
  }
